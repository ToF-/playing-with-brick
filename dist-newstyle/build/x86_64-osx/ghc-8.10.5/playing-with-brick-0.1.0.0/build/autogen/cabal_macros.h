...
/* package playing-with-brick-0.1.0.0 */
#ifndef VERSION_playing_with_brick
#define VERSION_playing_with_brick "0.1.0.0"
#endif /* VERSION_playing_with_brick */
#ifndef MIN_VERSION_playing_with_brick
#define MIN_VERSION_playing_with_brick(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_playing_with_brick */
...
#define CURRENT_PACKAGE_KEY "playing-with-brick-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "playing-with-brick-0.1.0.0-inplace"
